...
def generate_data():
    # Path to raw data
    data_path = 'saransh-experiments/cell2celltrain.csv'
    ...
    pipeline_strict.save_folds(df_eng, output_dir='saransh-experiments/processed_data_folds_strict')
    ...
    pipeline_permissive.save_folds(df_eng, output_dir='saransh-experiments/processed_data_folds_permissive')
