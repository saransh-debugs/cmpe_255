...
def main():
    ...
    res_strict = run_experiment('saransh-experiments/processed_data_folds_strict', 'STRICT (No Leakage)')
    
    # 2. Permissive View (With Leakage)
    res_permissive = run_experiment('saransh-experiments/processed_data_folds_permissive', 'PERMISSIVE (With Leakage)')
